...
trait TraversableJdbcEncoding {
  self: JdbcContext[_, _] =>

  implicit def seqStringEncoder[Col <: Traversable[String]]: Encoder[Col] = rawEncoder[String, Col](Types.VARCHAR)
  ...
  private def rawEncoder[T, Col <: Traversable[T]](jdbcType: Int): Encoder[Col] = seqEncoder[T, Col](jdbcType, _.asInstanceOf[AnyRef])
  ...
  protected def seqEncoder[T, Col <: Traversable[T]](jdbcType: Int, mapper: T => AnyRef): Encoder[Col] = {
